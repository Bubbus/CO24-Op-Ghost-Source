...
f_radios_settings_acre2_extraRadios = ["co","ftl","zeus"];
...
f_radios_settings_acre2_lr_groups_blufor = [
    ["GRND COMMAND 1",    ["ALPHA","BRAVO","CHARLIE","COMMAND","ENG1","MMG1","HMG1","MAT1","HAT1","MTR1","MSAM1","HSAM1","ST1","DT1"]],
    ["GRND COMMAND 2",    ["ZEUS","IFV2","IFV3","IFV4","IFV5","IFV6","IFV7","IFV8","TNK1"]],
